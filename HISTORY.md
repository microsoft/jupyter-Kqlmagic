...
- removed order restriction on connection string, simplified and unified connections string code parsing, improved error presentation, added friendly\_ to connection string (for case id is a uuid) - 0.1.46 - Oct 10, 2018
