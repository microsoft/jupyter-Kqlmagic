...
class AppinsightsEngine(KqlEngine):
    ...
    _VALID_KEYS_COMBINATIONS = [
        ...
        [ConnStrKeys.APPID, ConnStrKeys.ALIAS, ConnStrKeys.DATA_SOURCE_URL, ConnStrKeys.SUBSCRIPTION,                                      ConnStrKeys.AZCLI],
        [ConnStrKeys.APPID, ConnStrKeys.ALIAS, ConnStrKeys.DATA_SOURCE_URL, ConnStrKeys.TENANT,                                            ConnStrKeys.AZCLI],
