...
def test_sso_storage_good_env_string_rand_authority():
    os.environ[Constants.SSO_ENV_VAR_NAME] = f"{SsoEnvVarParam.CACHE_NAME}='cachename';    {SsoEnvVarParam.SECRET_KEY}='AKJSDNKF58345%$#@';     {SsoEnvVarParam.SECRET_SALT_UUID}='{uuid.uuid4()}';    {SsoEnvVarParam.CRYPTO}='fernet';    {SsoEnvVarParam.STORAGE}='ipythondb';"
    ...
    sso_store = get_sso_store(authority="authority")
