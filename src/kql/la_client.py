...
class LoganalyticsResult(dict):
    ...
    def __getitem__(self, key):
        if isinstance(key, slice):
            ...
            return LoganalyticsResult(mapping, dic)
...
class LoganalyticsResponseTable(six.Iterator):
...
class LoganalyticsClient(object):
    ...
    def execute(self, workspace, query: str, accept_partial_results=False, timeout=None):
        ...
        """
        return self.execute_query(workspace, query, accept_partial_results, timeout)

    def execute_query(self, workspace, query: str, accept_partial_results=False, timeout=None):
        """ Execute a simple query 
